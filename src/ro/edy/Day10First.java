...
public class Day10First {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("Result: " + new Day10First().processInput());
	...
	private String processInput() throws Exception {
		...
		while (matrixHasPointsInIt()) {
			...
			if (calculatedConnections == 1776 || calculatedConnections > 1765) {
	...
	class Point {
		...
		private Day10First getOuterType() {
			return Day10First.this;
		}
